...
return (
      <button
        ...
        aria-pressed={active}
        className={`flex-1 rounded-base inline-flex items-center justify-center gap-1.5 border ${padding} font-medium transition-neu duration-200 ease-in-out focus-visible:shadow-neu-xs focus-visible:border-border-default-strong ${
          active
