        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`rounded-DEFAULT inline-flex items-center justify-center px-2 py-1.5 text-xs font-medium transition-neu duration-200 focus-visible:shadow-neu-xs focus-visible:border-border-default-strong ${
                active
